...
namespace CRMPackageDeploymentTemplate1
{
    /// <summary>
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            get { return "This package will test deployment of solutions. This should unpackage a solution into source control and then pull that solution back together. "; }
        }
        ...
        {
            get { return "Testing Package Deployment"; }
        }
